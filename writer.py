...
letter_set = "set0"
trcolor = False
totalset = len(os.listdir("images/letterset")) + 1

htmlc = [
    "<html><head><style>.lines{width:100%;height:auto;float:left;}#paper{background:white;background-image:url('images/texture2.png');height:auto;float:left;padding:50px 50px;width:90%;}img,span{height:25px;width:15px;float:left;margin-top:5px;margin-bottom:10px;}.clblack{filter:brightness(30%);}.clblue{filter:brightness(100%);}</style></head><body><div id='paper'>"
]
    ...
    for line in textfile:
        ...
        for ch in curst:
            ...
            if chcode != 35 and chcode != 32 and chcode != 36:
                htmlc.append(
                    "<img src='images/letterset/{}/{}/{}.png'/style='margin-right:-9px'>".format(
