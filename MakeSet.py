...
ico = pygame.image.load("C:\\Users\\megha\\Desktop\\Projects\\MyHandWriting-version3 (1)\\MyHandWriting-version3\\images\\icon.png")
...
text = font.render("", True, (62, 97, 219))
screen.blit(text, (280, 210))
font = pygame.font.Font("freesansbold.ttf", 10)
text = font.render("", True, (240, 40, 90))
...
brush = pygame.image.load("C:\\Users\\megha\\Desktop\\Projects\\MyHandWriting-version3 (1)\\MyHandWriting-version3\\images\\brush.png")
...
def check_directory():
    ...
    if sdir:
        cdir = os.listdir("images/letterset")
        no_set = len(cdir)
        actset = no_set + 1
        actdirectory = "images/letterset/set{}".format(actset)
        os.mkdir(actdirectory)
        os.mkdir(actdirectory + "/blue")
        os.mkdir(actdirectory + "/black")
    else:
        os.mkdir("C:\\Users\\megha\\Desktop\\Projects\\MyHandWriting-version3 (1)\\MyHandWriting-version3\\images\\letterset")
        actset = 1
        actdirectory = "images/letterset/set{}".format(actset)
        os.mkdir(actdirectory)
        os.mkdir(actdirectory + "/blue")
        ...
        def check_directory():
            global actdirectory
            if not os.path.exists("images/letterset"):
                os.mkdir("images/letterset")
            else:
                cdir = os.listdir("images/letterset")
                no_set = len(cdir)
                actset = no_set + 1
